...
function EditProfile() {
  return (
    <>
      <Header />
      <h5 className="text-white bg-pink-800 mt-5 text-center h-11 w-auto pt-2 font-bold">
        EDIT PROFILE
      </h5>
      ...
      <form class="max-w-md mx-auto mt-10">
        <div class="grid md:grid-cols-2 md:gap-6">
          ...
          <div class="flex items-center mb-4">
            ...
            <input
              id="option-1"
              type="radio"
              className="ml-5 w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 "
              value="Male"
              name="radioGroup"
            />
            ...
            <label
              ...
              class="block ms-2  text-sm text-gray-500"
            >
              Male
            </label>
            <input
            ...
            <label
              ...
              class="block ms-2  ttext-sm text-gray-500"
            >
              Female
            </label>
          </div>
          ...
          <div class="flex items-center mb-4">
            <h1 className="text-sm text-gray-500">DOB: </h1>
        ...
        <button
          type="submit"
          class="text-white bg-pink-800 hover:bg-pink-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center "
        >
          Update
        </button>
      </form>
